	...
	public boolean useAdminCommand(String command, L2PcInstance activeChar)
	{
		...
		else if(command.startsWith("admin_reload"))
		{
			...
			try
			{
				...
				{
					L2ScriptEngineManager.getInstance().reload();
				...
				{
					SummonItemsData.getInstance().reload();
					activeChar.sendMessage("Summons reloaded");
				}
				
			}
			catch(Exception e)
			{
				activeChar.sendMessage("Usage:  //reload <quest|multisell|skill|npc|htm|item|summon|instancemanager>");
			}
		}
