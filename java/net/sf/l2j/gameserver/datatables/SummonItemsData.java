...
public class SummonItemsData
{
    ...
    private void load()
    {
        ...
        while (s.hasNextLine())
        {
            ...
            {
                _log.warning("Summon items data: Error in line " + lineCount + " -> incomplete/invalid data or wrong separator!");
                _log.warning("        " + line);
                ok = false;
            }
    ...
    public void reload()
    {
        _summonitems.clear(); // Limpa os dados atuais
        load(); // Recarrega os dados a partir do arquivo CSV
        _log.info("Summon items data: Reloaded summon items.");
    }
}
